...
class PointOfSale(models.Model):
    code = models.CharField(max_length=50, unique=True)
    name = models.CharField(max_length=100)
    gps_lat = models.FloatField(validators=[MinValueValidator(-90), MaxValueValidator(90)])
    gps_lon = models.FloatField(validators=[MinValueValidator(-180), MaxValueValidator(180)])
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['product', 'point_of_sale', 'date_from'],
